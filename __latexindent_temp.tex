...
\begin{cvsection}{Experience}
  \entry{Software Engineering MTS @ Tableau (Salesforce), VizQL Server}{01/20 - Present}
  {
    ...
    \item [current project] Improving the use of error codes and error sources for exceptions across the Tableau codebase to track causes of customer dissatisfaction and reduce MTTR for SLA-impacting issues.
