...
\begin{cvsection}{Work Experience}
  \entry{Software Engineering MTS - Salesforce / Tableau Software}{01/20 - Present}
  {
...
\begin{cvsection}{Selected Projects}
  ...
  {
    \item Developed an Airdrop-like P2P network in Python using FUSE, hosted on a multithreaded bootstrap server
  }
  \entry{Packet Sniffer}{}
  {
    \item Wrote a packet sniffer using raw network sockets in Python and parsed TCP, UDP, IP, Ethernet, and DNS
  }
