...
\begin{cvsection}{Employment}
  \entryheader{Member of Technical Staff, Tableau Software / Salesforce}{Jan. '20 - Present}
  \entryheader{Senior Software Engineer, Tableau Prep Engine}{May '22 - Present}
  \entry{
    \item Creating a log pipeline and visualizations to enable support engineers to analyze Prep log files in Tableau
  }
