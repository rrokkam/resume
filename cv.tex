...
\begin{cvsection}{Employment}
  ...
  \entry{
    ...
    \item Contributed to implementation of Parameters feature for Prep flow jobs
    \item Debugged tricky shipblocking internal compiler errors leading to generation of incorrect queries
  ...
  \entryheader{Software Engineer, Tableau VizQL Server}{Jan '20 - May '21}
  \entry{
...
\begin{cvsection}{Projects}
  ...
  \entry
  {
    \item Made a shell in C that supports output redirection, piping, signal handling, and background job support while carefully considering race conditions
  }
\end{cvsection}
